...
const localAgents: Agent[] = [
  ...
  // Transparent Partners AI Development Agents
  {
    id: 'ai-hub-manager',
    name: 'AI Hub Manager',
    ...
    allowedClients: ['transparent-partners'],
    submitterId: 'transparent-partners-system',
    submitterEmail: 'ai@transparent.partners',
    submitterName: 'Transparent Partners AI Team',
    submissionDate: '2024-01-15T00:00:00Z',
    reviewedBy: 'transparent-partners-system',
    reviewerEmail: 'ai@transparent.partners',
    reviewerName: 'Transparent Partners AI Team',
    approvalDate: '2024-01-15T00:00:00Z',
    rejectionReason: '',
    auditTrail: [],
  ...
  
  {
    ...
    description: 'Transparent Partners\' AI performance monitoring agent that tracks system performance, agent efficiency, and resource utilization.',
    provider: 'anthropic',
    route: '/agents/performance-monitor',
    visibility: 'company',
    status: 'approved',
    metadata: {
      tags: ['performance', 'monitoring', 'efficiency', 'transparent-partners'],
  ...
  
  {
    ...
    description: 'AI-powered interview preparation and coaching agent that helps candidates prepare for job interviews with personalized feedback and practice sessions.',
    provider: 'openai',
    route: '/agents/interview-agent',
    visibility: 'company',
    status: 'approved',
    metadata: {
      tags: ['interview', 'coaching', 'career', 'preparation', 'transparent-partners'],
  ...
  {
    id: 'campaign-brief-agent',
    name: 'Campaign Brief Agent',
    description: 'AI marketing campaign brief generator that creates comprehensive campaign strategies, target audience analysis, and creative briefs for marketing teams.',
    provider: 'anthropic',
    route: '/agents/campaign-brief-agent',
    visibility: 'company',
    status: 'approved',
    metadata: {
      tags: ['campaign', 'marketing', 'brief', 'strategy', 'transparent-partners'],
      category: 'Marketing',
      tier: 'premium',
      permissionType: 'approval'
    },
  ...
  
  {
    id: 'gemini-chat-agent',
    name: 'Gemini Chat Agent',
    description: 'Google\'s advanced Gemini AI chat agent for intelligent conversations, creative writing, and problem-solving across multiple domains.',
    provider: 'google',
    route: '/agents/gemini-chat-agent',
    visibility: 'company',
    status: 'approved',
    metadata: {
      tags: ['gemini', 'chat', 'google', 'ai', 'conversation', 'transparent-partners'],
      category: 'AI Development',
      tier: 'premium',
      permissionType: 'approval'
    },
  ...
  
  {
    id: 'imagen-agent',
    name: 'Imagen Agent',
    description: 'Google\'s Imagen AI image generation agent that creates high-quality, creative images from text descriptions for design and content creation.',
    provider: 'google',
    route: '/agents/imagen-agent',
    visibility: 'company',
    status: 'approved',
    metadata: {
      tags: ['imagen', 'image-generation', 'google', 'ai', 'creative', 'transparent-partners'],
      category: 'Creative AI',
      tier: 'premium',
      permissionType: 'approval'
    },
